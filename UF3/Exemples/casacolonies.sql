...
-- Aquesta sentència de creació no és correcta (la PK ha d'estar formada per les dues FK)
...
-- Sentència de creació correcta quan 2 FK han de ser la PK d'una taula
CREATE TABLE IF NOT EXISTS oferta(
	id_casa INT NOT NULL,
	id_activitat INT NOT NULL,
	PRIMARY KEY (id_casa, id_activitat),
	FOREIGN KEY (id_casa) REFERENCES casa_colonies(id),
	FOREIGN KEY (id_activitat) REFERENCES activitat(id)	
);
...
--Aquesta inserció no és correcta (explicat al comentari línia 37)
INSERT INTO oferta VALUES (NULL, 1, 4), (NULL, 2, 1), (NULL, 3, 2), (NULL, 4, 3);

INSERT INTO oferta VALUES (1, 4), ( 4, 3);
